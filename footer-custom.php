...
<script src="https://kit.fontawesome.com/6bc5b37400.js" crossorigin="anonymous"></script>
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.vide.min.js" ></script>

<script type="text/javascript">
jQuery(document).ready(function(){
jQuery('.search-box').focusout(function(){
jQuery('.search-box input').animate({
width: [ "toggle", "swing" ]}).show()
})
jQuery('.search-box span').click(function(){
jQuery('.search-box input').animate({
...
jQuery('#modal4').on('hidden.bs.modal', function (e) {
  ...
  jQuery('#modal4 iframe').attr("src", jQuery("#modal4 iframe").attr("src"));
   ...
   jQuery("#btn1").click(function() {
    jQuery("#form1-result").hide();
    jQuery("#form2-result").hide();
